...
#define MAVLINK_MSG_ID_POSITION_CONTROL_OFFSET_SET_CRC 115
#define MAVLINK_MSG_ID_160_CRC 115
						       ...
						       uint8_t target_system, uint8_t target_component, float x, float y, float z, float yaw)
{
	...
	char buf[MAVLINK_MSG_ID_POSITION_CONTROL_OFFSET_SET_LEN];
	...
	_mav_put_float(buf, 14, yaw);
        ...
        memcpy(_MAV_PAYLOAD_NON_CONST(msg), buf, MAVLINK_MSG_ID_POSITION_CONTROL_OFFSET_SET_LEN);
#else
	...
	packet.yaw = yaw;
        ...
        memcpy(_MAV_PAYLOAD_NON_CONST(msg), &packet, MAVLINK_MSG_ID_POSITION_CONTROL_OFFSET_SET_LEN);
#endif

	msg->msgid = MAVLINK_MSG_ID_POSITION_CONTROL_OFFSET_SET;
#if MAVLINK_CRC_EXTRA
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_POSITION_CONTROL_OFFSET_SET_LEN, MAVLINK_MSG_ID_POSITION_CONTROL_OFFSET_SET_CRC);
#else
						           ...
						           uint8_t target_system,uint8_t target_component,float x,float y,float z,float yaw)
{
	...
	msg->msgid = MAVLINK_MSG_ID_POSITION_CONTROL_OFFSET_SET;
#if MAVLINK_CRC_EXTRA
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_POSITION_CONTROL_OFFSET_SET_LEN, MAVLINK_MSG_ID_POSITION_CONTROL_OFFSET_SET_CRC);
#else
...
/**
 * @brief Encode a position_control_offset_set struct
 *
 * @param system_id ID of this system
 * @param component_id ID of this component (e.g. 200 for IMU)
 * @param msg The MAVLink message to compress the data into
...
/**
 * @brief Encode a position_control_offset_set struct on a channel
 *
 * @param system_id ID of this system
 * @param component_id ID of this component (e.g. 200 for IMU)
 * @param chan The MAVLink channel this message will be sent over
 ...
 * @param position_control_offset_set C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_position_control_offset_set_encode_chan(uint8_t system_id, uint8_t component_id, uint8_t chan, mavlink_message_t* msg, const mavlink_position_control_offset_set_t* position_control_offset_set)
{
	return mavlink_msg_position_control_offset_set_pack_chan(system_id, component_id, chan, msg, position_control_offset_set->target_system, position_control_offset_set->target_component, position_control_offset_set->x, position_control_offset_set->y, position_control_offset_set->z, position_control_offset_set->yaw);
}
...
#if MAVLINK_CRC_EXTRA
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_POSITION_CONTROL_OFFSET_SET, buf, MAVLINK_MSG_ID_POSITION_CONTROL_OFFSET_SET_LEN, MAVLINK_MSG_ID_POSITION_CONTROL_OFFSET_SET_CRC);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_POSITION_CONTROL_OFFSET_SET, buf, MAVLINK_MSG_ID_POSITION_CONTROL_OFFSET_SET_LEN);
#endif
#else
	mavlink_position_control_offset_set_t packet;
	packet.target_system = target_system;
...
#if MAVLINK_CRC_EXTRA
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_POSITION_CONTROL_OFFSET_SET, (const char *)&packet, MAVLINK_MSG_ID_POSITION_CONTROL_OFFSET_SET_LEN, MAVLINK_MSG_ID_POSITION_CONTROL_OFFSET_SET_CRC);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_POSITION_CONTROL_OFFSET_SET, (const char *)&packet, MAVLINK_MSG_ID_POSITION_CONTROL_OFFSET_SET_LEN);
#endif
#endif
}
...
#else
	memcpy(position_control_offset_set, _MAV_PAYLOAD(msg), MAVLINK_MSG_ID_POSITION_CONTROL_OFFSET_SET_LEN);
#endif
}
