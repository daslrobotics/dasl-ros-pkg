...
(cl:defmethod cl:initialize-instance :after ((m <Pose>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Pose)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dasl_mocap-msg:<Pose> is deprecated: use dasl_mocap-msg:Pose instead.")))
...
(cl:defmethod theta-val ((m <Pose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dasl_mocap-msg:theta-val is deprecated.  Use dasl_mocap-msg:theta instead.")
  (theta m))

(cl:ensure-generic-function 'linear_velocity-val :lambda-list '(m))
(cl:defmethod linear_velocity-val ((m <Pose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dasl_mocap-msg:linear_velocity-val is deprecated.  Use dasl_mocap-msg:linear_velocity instead.")
  (linear_velocity m))

(cl:ensure-generic-function 'angular_velocity-val :lambda-list '(m))
(cl:defmethod angular_velocity-val ((m <Pose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dasl_mocap-msg:angular_velocity-val is deprecated.  Use dasl_mocap-msg:angular_velocity instead.")
  (angular_velocity m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Pose>)))
  ...
  "6f37b4ac78d63d30fc93558b1e833cae")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Pose)))
  "Returns md5sum for a message object of type 'Pose"
  "6f37b4ac78d63d30fc93558b1e833cae")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Pose>)))
  ...
  (cl:format cl:nil "float32 x~%float32 y~%float32 z~%float32 theta~%~%float32 linear_velocity~%float32 angular_velocity~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Pose)))
  "Returns full string definition for message of type 'Pose"
  (cl:format cl:nil "float32 x~%float32 y~%float32 z~%float32 theta~%~%float32 linear_velocity~%float32 angular_velocity~%~%~%"))
