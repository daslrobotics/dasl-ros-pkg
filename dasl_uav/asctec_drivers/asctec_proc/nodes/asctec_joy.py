...
#from mav_msgs import Roll, Pitch, YawRate, Thrust
#from mav_srvs.srv import ChaseDesPose, ToggleEngage, Takeoff, Land, ESTOP, PositionHold, VelocityHold
...
import tty
import select
roslib.load_manifest('asctec_proc')
...
from sensor_msgs.msg import Imu, NavSatStatus, NavSatFix
...
class MCN():
	...
	self.gripper = 1500
        ...
        rospy.wait_for_service('/mav/setMotorsOnOff')
        self.toggleEngage = rospy.ServiceProxy('/mav/setMotorsOnOff', SetSpeed)
